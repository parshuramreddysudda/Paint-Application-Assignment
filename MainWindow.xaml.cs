...
namespace PaintApplicationAssignment
{
    public partial class MainWindow : Window
    {
        ...
        private double sprayDensity = 8; // Default spray density
        private double currentEraserSize = 2; // Default eraser size
        private SprayEffect currentSprayEffect;
        ...
        private void ThicknessSlider_ValueChanged(object sender, RoutedPropertyChangedEventArgs<double> e)
        {
            if (IsLoaded)
            {
                ...
                else if (SprayBtn.IsChecked == true)
                {
                    // Update spray density directly from the thickness slider value
                    sprayDensity = ThicknessSlider.Value;
                    SprayBtn_Click(null, null);
                }
            }
        }
        ...
        //  All Clickable Methods

        private void SprayBtn_Click(object sender, RoutedEventArgs e)
        {
            // Stop the current SprayEffect if it exists
            if (currentSprayEffect != null)
            {
                currentSprayEffect.StopSpraying();
            }
            ...
            double sprayRadius = ThicknessSlider.Value * 5; // Use the thickness slider value as the spray radius
            int particlesPerSecond = (int)(100000 * sprayDensity); // Adjust this value to change the spray density

            // Create a new instance of SprayEffect
            currentSprayEffect = new SprayEffect(Canvas, sprayRadius, particlesPerSecond, PenAttributes);
            //Debug.WriteLine(" Outside Per second" + currentSprayEffect + " Spray Radius is ");

            // Start the spray functionality
            currentSprayEffect.StartSpraying();
        }
      ...
      private void SelectBtn_Click(object sender, RoutedEventArgs e)
        ...
        private void ClearButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                // For Clearing all the spray effect.
                Canvas.Children.Clear();
        ...
        private void SetEditingMode(EditingMode mode)
        {
            ...
            // For Better Switching we implemented Switch instead of If else
            switch (mode)
            {
            ...
            // For Showing the user, their current Selection
        ...
        //For Handling Exceptions, we can later modify this for storing logs in different ways depending upon the File Types and other categories.
